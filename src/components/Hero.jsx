...
export const Hero = ({ navigate }) => {
  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'absolute', bottom: 0, left: 0, width: '100%', background: 'var(--accent-gold)', padding: 'clamp(8px, 2vw, 16px) 0', zIndex: 0, overflow: 'hidden', borderTop: '4px solid #000', borderBottom: '4px solid #000', boxShadow: '0 0 30px rgba(255, 215, 0, 0.4)' }}>
        <motion.div
